...
(function () {
  ...
  d.AxisBase = d.Class({
    construct: function (a) {
      ...
      this.periods = [{period: "fff", count: 1}, {period: "fff", count: 5}, {period: "fff", count: 10}, {
        period: "fff",
        count: 50
      }, {period: "fff", count: 100}, {period: "fff", count: 500}, {period: "ss", count: 1}, {
        period: "ss",
        count: 5
      }, {period: "ss", count: 10}, {period: "ss", count: 30}, {period: "mm", count: 1}, {
        period: "mm",
        count: 5
      ...
      if (a) {
        ...
        var g = h.width, h = h.height, k = this.width, l = this.height, m = 0, n = a.getBBox().height / 2, q = this.inside, p = this.titleAlign;
      ...
      var w, y = this.gridAlpha, x, u = this.choosePeriod(0), A = u.period, u = u.count, z = d.getPeriodDuration(A, u);
      z < k && (A = g.period, u = g.count, z = k);
      g = A;
      "WW" == g && (g = "DD");
      this.stepWidth = this.getStepWidth(this.timeDifference);
      var B = Math.ceil(this.timeDifference / z) + 5, D = l = d.resetDateToMin(new Date(this.startTime - z), A, u, t).getTime();
      ...
      if (0 < this.gridCountR)for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
        ...
        this.pushAxisItem(m);
        m = l = p;
        if (!isNaN(w))for (h = 1; h < u; h += w)this.gridAlpha = this.minorGridAlpha, f = p + x * h, f = d.resetDateToMin(new Date(f), A, w, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
        this.gridAlpha = y
      }
...
(function () {
  ...
  d.ValueAxis = d.Class({
    inherits: d.AxisBase, construct: function (a) {
      ...
      this.synchronizationMultiplier && this.synchronizeWith ? (d.isString(this.synchronizeWith) && (this.synchronizeWith = a.getValueAxisById(this.synchronizeWith)), this.synchronizeWith && (this.synchronizeWithAxis(this.synchronizeWith), this.foundGraphs = !0)) : (this.foundGraphs = !1, this.getMinMax(), 0 === this.start && this.end == this.data.length - 1 && isNaN(this.minZoom) && isNaN(this.maxZoom) && (this.fullMin = this.min, this.fullMax = this.max, "date" != this.type && this.strictMinMax && (isNaN(this.minimum) || (this.fullMin = this.minimum), isNaN(this.maximum) || (this.fullMax = this.maximum)), this.logarithmic && (this.fullMin = this.logMin, 0 === this.fullMin && (this.fullMin = this.treatZeroAs)), "date" == this.type && (this.minimumDate || (this.fullMin = this.minRR), this.maximumDate || (this.fullMax = this.maxRR))))
    }, draw: function () {
      ...
      if (this.logarithmic) {
        var e = this.treatZeroAs, h = this.getExtremes(0, this.data.length -
          1).min;
      ...
      if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
        ...
        !0 === h ? (w = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth /
        ...
        if (this.autoGridCount || 0 !== this.gridCount)if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), c = this.minCalc, h && (r++, c = this.maxCalc - r * y), this.gridCountReal = r, g = this.startCount = t; g < r; g += p)if (t = y * g + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t)if (isNaN(x) || Number(d.toFixed(t, x)) == t) {
          ...
          if (!isNaN(z) && 0 < A && g < r - 1) {
            ...
            for (H = 1; H < f; H++) {
              var P =
                this.getCoordinate(t + z * H), P = new this.axisItemRenderer(this, P, "", !1, 0, 0, !1, !1, 0, !0);
              this.pushAxisItem(P)
            }
            this.gridAlpha = K
          }
      ...
      if (this.logarithmic) {
        var h = Math.log(h) * Math.LOG10E - Math.log(e) * Math.LOG10E, f = Math.log(b) / Math.LN10 -
      ...
      0 === this.relativeStart && 1 == this.relativeEnd && (this.maxZoom = this.minZoom = NaN), !0
...
(function () {
  ...
  d.RecAxis = d.Class({
    construct: function (a) {
      var b = a.chart, c = a.axisThickness, e = a.axisColor, h = a.axisAlpha, f = a.offset, g = a.dx, k = a.dy, l = a.x, m = a.y, n = a.height, q = a.width, p = b.container;
...
(function () {
  ...
  d.RecItem = d.Class({
    construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
      ...
      this.set = x;
      var u = a.axisThickness, A = a.axisColor, z = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, K = a.gridColor, H = a.dashLength, P = a.fillColor, O = a.fillAlpha, R = a.labelsEnabled;
      n = a.labelRotationR;
      var ia = a.counter, I = a.inside, aa = a.labelOffset, wa = a.dx, ma = a.dy, Pa = a.orientation, Z = a.position, da = a.previousCoord, X = a.height, Aa = a.width, ea = a.offset, fa, Ba;
      ...
      var V = n * Math.PI / 180, Y, Da, G = 0, v = 0, na = 0, ha = Y = 0, Qa = 0;
      "V" == Pa && (n = 0);
      var ca;
      R && "" !== c && (ca = a.autoWrap && 0 === n ? d.wrappedText(y, c, w, t, r, ga, k, Math.abs(h), 0) : d.text(y, c, w, t, r, ga, k), ga = ca.getBBox(), ha = ga.width, Qa = ga.height);
      if ("H" == Pa) {
        if (0 <= b && b <= Aa + 1 && (0 < B && 0 < z && b + l <= Aa + 1 && (fa = d.line(y, [b + l, b + l], [0, B], A, z, C), x.push(fa)), 0 < D && (Ba = d.line(y, [b, b + wa, b + wa], [X, X + ma, ma], K, D, C, H), x.push(Ba))), v = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ga = "start", v = "bottom" == Z ? I ? v + B : v - B : I ? v - B : v + B, G += 3, 0 < h && (G += h / 2 - 3, ga = "middle"), 0 < n && (ga = "middle")) : ga = "middle", 1 == ia && 0 < O && !g && !m && da < Aa && (e = d.fitToBounds(b, 0, Aa), da = d.fitToBounds(da, 0, Aa), Y = e - da, 0 < Y && (Da = d.rect(y, Y, a.height, P, O), Da.translate(e - Y + wa, ma), x.push(Da))), "bottom" == Z ? (v += X + r / 2 + ea, I ? (0 < n ? (v = X - ha / 2 * Math.sin(V) - B - 3, a.centerRotatedLabels || (G += ha / 2 * Math.cos(V) - 4 + 2)) : 0 > n ? (v = X + ha * Math.sin(V) - B - 3 + 2, G += -ha * Math.cos(V) - Qa * Math.sin(V) - 4) : v -= B + r + 3 + 3, v -= aa) : (0 < n ? (v = X + ha / 2 * Math.sin(V) + B + 3, a.centerRotatedLabels || (G -= ha / 2 * Math.cos(V))) : 0 > n ? (v = X + B + 3 - ha / 2 * Math.sin(V) + 2, G += ha / 2 * Math.cos(V)) : v += B + u + 3 + 3, v += aa)) : (v += ma + r / 2 - ea, G += wa, I ? (0 < n ? (v = ha / 2 * Math.sin(V) + B + 3, a.centerRotatedLabels || (G -= ha / 2 * Math.cos(V))) : v += B + 3, v += aa) : (0 < n ? (v = -(ha / 2) * Math.sin(V) - B - 6, a.centerRotatedLabels || (G += ha / 2 * Math.cos(V))) : v -= B +
            r + 3 + u + 3, v -= aa)), "bottom" == Z ? Y = (I ? X - B - 1 : X + u - 1) + ea : (na = wa, Y = (I ? ma : ma - B - u + 1) - ea), f && (G += f), r = G, 0 < n && (r += ha / 2 * Math.cos(V)), ca && (f = 0, I && (f = ha / 2 * Math.cos(V)), r + f > Aa + 2 || 0 > r))ca.remove(), ca = null
      } else {
        ...
        v += r / 2;
        "right" == Z ? (G += wa + Aa + ea, v += ma, I ? (f || (v -= r / 2 + 3), G = G - (B + 4) - aa) : (G += B + 4 + u, v -= 2, G += aa)) : I ? (G += B + 4 - ea, f || (v -= r / 2 + 3), g && (G += wa, v += ma), G += aa) : (G += -B - u - 4 - 2 - ea, v -= 2, G -= aa);
  ...
  d.AmChart = d.Class({
    construct: function (a) {
      ...
      if (b.container && !1 !== a.enabled) {
        ...
        var c = a.y, e = a.text, h = a.align, f = a.size, g = a.color, k = a.rotation, l = a.alpha, m = a.bold, n = d.toCoordinate(a.x, b.realWidth), c = d.toCoordinate(c, b.realHeight);
        n || (n = 0);
        c || (c = 0);
        void 0 === g && (g = b.color);
    ...
    construct: function (a) {
      ...
      for (m = this.start; m <= this.end; m++) {
        ...
        if (isNaN(q))this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
          ...
          c.push(t);
          if (!isNaN(p)) {
            var w = this.valueAxis.getCoordinate(p, this.noRounding) - this.height, w = w * this.valueAxis.rMultiplier, y = w * Math.sin(r / 180 * Math.PI), r = w * Math.cos(r / 180 * Math.PI);
            e.push(y);
            d.push(r);
            isNaN(k) && (k = y);
            isNaN(l) && (l = r)
      ...
      if (e) {
        var f = this.chart, g = this.valueAxis, k = "middle", l = !1, m = this.labelPosition, n = e.getBBox(), q = this.chart.rotate, p = a.isNegative, t = this.fontSize;
      ...
      isNaN(k) && (k = .8);
      var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate, r = this.columnCount, w = d.toCoordinate(this.cornerRadiusTop, k / 2), y = this.connect, x = [], u = [], A, z, B, D, C = this.chart.graphs.length, K, H = this.dx / this.tcc, P = this.dy / this.tcc, O = f.stackType, R = this.start, ia = this.end, I = this.scrollbar, aa = "graph-column-";
      I && (aa = "scrollbar-graph-column-");
      var wa = this.categoryAxis, ma = this.baseCoord, Pa = this.negativeBase, Z = this.columnIndex, da = this.lineThickness, X = this.lineAlpha, Aa = this.lineColorR, ea = this.dashLength, fa = this.set, Ba, ga = this.getGradRotation(), V = this.chart.columnSpacing, Y = wa.cellWidth, Da = (Y * k - r) / r;
      V > Da && (V = Da);
      var G, v, na, ha = q, Qa = n, ca = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Ra = this.negativeFillColors, Ja = this.negativeLineColor, Ya = this.fillAlphas, Za = this.negativeFillAlphas;
      ...
      if ("line" == g || "step" == g || "smoothedLine" == g) {
        if (0 < R) {
          for (L = R - 1; -1 < L; L--)if (G = e[L], v = G.axes[f.id].graphs[b], na = v.values.value, !isNaN(na)) {
            R = L;
            break
          }
          if (this.lineColorField)for (L =
                                         R; -1 < L; L--)if (G = e[L], v = G.axes[f.id].graphs[b], v.lineColor) {
            this.bulletColorSwitched = this.lineColorSwitched = v.lineColor;
            break
          }
          if (this.fillColorsField)for (L = R; -1 < L; L--)if (G = e[L], v = G.axes[f.id].graphs[b], v.fillColors) {
            this.fillColorsSwitched = v.fillColors;
            break
          }
          if (this.dashLengthField)for (L = R; -1 < L; L--)if (G = e[L], v = G.axes[f.id].graphs[b], !isNaN(v.dashLength)) {
            this.dashLengthSwitched = v.dashLength;
            break
          }
        }
        if (ia < e.length - 1)for (L = ia + 1; L < e.length; L++)if (G = e[L], v = G.axes[f.id].graphs[b], na = v.values.value, !isNaN(na)) {
          ia = L;
          break
        }
      }
      ...
      for (L = R; L <= ia; L++) {
        ...
        var S, Q, J, ba, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN, pa = NaN, qa = NaN, ra = NaN, sa = NaN, xa = NaN, Ea = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Na = wb, Va = Ya, Ha = Aa, Ca, ya, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, oa = n - 1, bb = this.pattern;
        ...
        if (Ia) {
          ...
          var ja = G.x[wa.id], Wa = this.periodSpan - 1;
          "step" != g || isNaN(G.cellWidth) || (Y = G.cellWidth);
          var va = Math.floor(Y / 2) + Math.floor(Wa * Y / 2), Ga = va, nb = 0;
          ...
          if (!Bb && W < ta || Bb && W < Ba)v.isNegative = !0, Ra && (Na = Ra), Za && (Va = Za), void 0 != Ja && (Ha = Ja);
          $a = !1;
          ...
          switch (g) {
            case"line":
              if (isNaN(W))y || (this.drawLineGraph(x, u, T, U), x = [], u = [], T = [], U = []); else {
                if (Math.abs(E -
            ...
            case"smoothedLine":
              if (isNaN(W))y || (this.drawSmoothedGraph(x, u, T, U), x = [], u = [], T = [], U = []); else {
                ...
                la = F;
                !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M));
                void 0 == v.lineColor && void 0 == v.fillColors && isNaN(v.dashLength) || (this.drawSmoothedGraph(x, u, T, U), x = [E], u = [F], T = [], U = [], !Ma || isNaN(M) || isNaN(N) || (T.push(N), U.push(M)), this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors, this.dashLengthSwitched = v.dashLength);
              ...
              if (!isNaN(W)) {
                ...
                if (!(W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                  ...
                  if (t) {
                    ...
                    isNaN(G.percentWidthValue) || (J = this.height * G.percentWidthValue /
                      100, Q = ja - J / 2, Ea = Q + J / 2);
                    J = d.roundTo(J, 2);
                    ba = d.roundTo(ba, 2);
                    Q < q && 0 < J && (ua = new d.Cuboid(h, ba, J, H - a.d3x, P - a.d3y, Na, Va, da, Ca, X, ga, w, t, ea, bb, mb, aa), v.columnWidth = Math.abs(ba), v.columnHeight = Math.abs(J))
                  } else {
                    ...
                    J = d.roundTo(J, 2);
                    ba = d.roundTo(ba, 2);
                    S < n + Z * H && 0 < J && (this.showOnAxis && (Q -= P / 2), ua = new d.Cuboid(h, J, ba, H - a.d3x, P - a.d3y, Na, Va, da, Ca, this.lineAlpha, ga, w, t, ea, bb, mb, aa), v.columnHeight = Math.abs(ba), v.columnWidth = Math.abs(J))
                  }
                }
                if (ua) {
                  ya = ua.set;
                  ...
                  Q = d.roundTo(Q, 2);
                  ya.translate(S, Q);
                  (v.url || this.showHandOnHover) && ya.setAttr("cursor", "pointer");
                  if (!I) {
                    "none" == O && (K = t ? (this.end + 1 - L) * C - c : C * L + c);
                    "3d" == O && (t ? (K = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, xa += H * Z, ka += H * Z, v.y += H * Z) : (K = (C - c) * (L + 1) + 1E3 * this.depthCount, Ea += P * Z, la += P * Z, v.y += P * Z));
                    if ("regular" == O || "100%" == O)K = t ? 0 < Ia.value ? (this.end + 1 - L) * C + c : (this.end + 1 - L) * C - c : 0 < Ia.value ? C * L + c : C * L - c;
                    this.columnsArray.push({column: ua, depth: K});
                    v.x = t ? Q + J / 2 : S + J / 2;
                    this.ownColumns.push(ua);
                    this.animateColumns(ua, L, E, N, F, M);
                    this.addListeners(ya, v);
            ...
            case"candlestick":
              if (!isNaN(ta) && !isNaN(W)) {
                ...
                if (t) {
                  ...
                  if (Q < q && 0 < J) {
                    var Eb, Fb;
                    W > ta ? (Eb = [E, ra], Fb = [N, pa]) : (Eb = [N, ra], Fb = [E, pa]);
                    !isNaN(ra) && !isNaN(pa) && F < q && 0 < F && (Xa = d.line(h, Eb, [F, F], Ca, X, da), cb = d.line(h, Fb, [F, F], Ca, X, da));
                    ba = E - N;
                    ua = new d.Cuboid(h, ba, J, H, P, Na, Ya, da, Ca, X, ga, w, t, ea, bb, mb, aa)
                  }
                } else {
                  "open" == l && (la = M);
                  "high" == l && (la = sa);
                  ...
                  if (S < n && 0 < J) {
                    Bb && W >= ta && (Va = 0);
                    var ua = new d.Cuboid(h, J, ba, H, P, Na, Va, da, Ca, X, ga, w, t, ea, bb, mb, aa), Gb, Hb;
                    W > ta ? (Gb = [F, sa], Hb = [M, qa]) : (Gb = [M, sa], Hb = [F, qa]);
                    !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Gb, Ca, X, da), cb = d.line(h, [E, E], Hb, Ca, X, da), d.setCN(a, Xa, this.bcn + "line-high"), v.className && d.setCN(a, Xa, v.className, !0), d.setCN(a, cb, this.bcn + "line-low"), v.className && d.setCN(a, cb, v.className, !0))
                  }
                }
                ua && (ya = ua.set, v.columnGraphics = ya, fa.push(ya), ya.translate(S, Q - da / 2), (v.url || this.showHandOnHover) && ya.setAttr("cursor", "pointer"), Xa && (fa.push(Xa), fa.push(cb)), I || (v.x = t ? Q + J / 2 : S + J / 2, this.animateColumns(ua, L, E, N, F, M), this.addListeners(ya, v), void 0 !== this.tabIndex && ya.setAttr("tabindex", this.tabIndex)))
              }
              break;
            case"ohlc":
              if (!(isNaN(ta) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                ...
                if (t) {
                  ...
                  "high" == l && (la = sa);
                  "low" == l && (la = qa);
                  var ka = E, qa = d.fitToBounds(qa, 0, Fa), sa = d.fitToBounds(sa, 0, Fa), Kb = E - k / 2, Kb = d.fitToBounds(Kb, 0, n), Ub = d.fitToBounds(E, 0, n), Lb = E + k / 2, Lb = d.fitToBounds(Lb, 0, n);
          ...
          if (!I && !isNaN(W)) {
            ...
            if (this.end -
              ...
              if (Xb && !isNaN(xa) && !isNaN(xa)) {
                ...
                Wb && (Yb = Wb.size);
                this.positionLabel(v, xa, Ea, gc, Yb)
              }
              if ("regular" == O || "100%" == O) {
                var Zb = f.totalText;
                if (Zb) {
      ...
      this.lastDataItem = v;
      if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(x, u, T, U) : this.drawLineGraph(x, u, T, U), I || this.launchAnimation();
      ...
      if (1 < a.length) {
        ...
        h.push(l);
        h.push(k);
        var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, w = this.negativeFillColors, y = this.negativeFillAlphas, x = this.baseCoord, u = this.lineColorSwitched;
        u && (p = u);
      ...
      if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
        ...
        a.isNegative && void 0 !==
        this.bulletColorNegative && (q = this.bulletColorNegative);
    ...
    construct: function (a) {
      ...
      if (this.mouseIsDown) {
        var a = d.roundTo((this.mouseX - this.mouseX0) / this.width,
          3), b = d.roundTo((this.mouseY - this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) / this.width, 3), e = d.roundTo((this.mouse2Y - this.mouse2Y0) / this.height, 2), h = !1;
...
(function () {
  ...
  d.SimpleChartScrollbar = d.Class({
    construct: function (a) {
      ...
      var a = this.getDBox(), b = a.x, c = a.y, e = this.iconLeft, d = this.iconRight, f, g, k = this.scrollbarHeight;
  ...
  d.ChartScrollbar = d.Class({
    inherits: d.SimpleChartScrollbar, construct: function (a) {
      ...
      if (a.enabled) {
        ...
        var b = a.chart, c = b.chartData, e = a.categoryAxis, h = a.rotate, f = a.x, g = a.y, k = a.width, l = a.height, m = a.gridAxis, n = a.set;
        e.setOrientation(!h);
  ...
  d.AmBalloon = d.Class({
    construct: function (a) {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          var g = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, q = this.fillColor, p = this.borderColor, t = q;
          void 0 != n && (this.adjustBorderColor ? t = p = n : q = n);
          var r = this.horizontalPadding, w = this.verticalPadding, y = this.pointerWidth, x = this.pointerOrientation, u = this.cornerRadius, A = c.fontFamily, z = this.fontSize;
          ...
          D < g && (D = g);
          D + C > l && (D = l - C);
          var k = z + w, m = D + r, O = this.shadowAlpha, R = this.shadowColor, r = this.borderThickness, ia = this.bulletSize, I, w = this.fillAlpha, aa = this.borderAlpha;
          this.showBullet && (I = d.circle(h, ia, t, w), f.push(I));
          this.drop ? (g = C / 1.6, l = 0, "V" == x && (x = "down"), "H" == x && (x = "left"), "down" == x && (D = a + 1, z = b - g - g / 3), "up" == x && (l = 180, D = a + 1, z = b + g + g / 3), "left" == x && (l = 270, D = a + g + g / 3 + 2, z = b), "right" == x && (l = 90, D = a - g - g / 3 + 2, z = b), k = z - H / 2 + 1, m = D - K / 2 - 1, q = d.drop(h, g, l, q, w, r, p, aa)) : 0 < u || 0 === y ? (0 < O && (a = d.rect(h, C, A, q, 0, r +
            1, R, O, u), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(h, C, A, q, w, r, p, aa, u)) : (t = [], u = [], "H" != x ? (g = a - D, g > C - y && (g = C - y), g < y && (g = y), t = [0, g - y, a - D, g + y, C, C, 0, 0], u = P ? [0, 0, b - z, 0, 0, A, A, 0] : [A, A, b - z, A, A, 0, 0, A]) : (x = b - z, x > A - y && (x = A - y), x < y && (x = y), u = [0, x - y, b - z, x + y, A, A, 0, 0], t = a < g + (l - g) / 2 ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0] : [C, C, D + C > a ? C : a - D, C, C, 0, 0, C]), 0 < O && (a = d.polygon(h, t, u, q, 0, r, R, O), a.translate(1, 1), f.push(a)), q = d.polygon(h, t, u, q, w, r, p, aa));
          this.bg = q;
          f.push(q);
          q.toFront();
          ...
          0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({translate: D - h + "," + z}, b, "easeOutSine"), n && (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
          this.prevX = D - h;
          this.prevY = z;
          this.prevTX = m;
          this.prevTY = k
        ...
        for (K = 0; K < C.length; K++) {
          ...
          for (P = 0; P < h.length; P++) {
            ...
            if (b.valueAxis.id == H) {
              ...
              !b.connect && z && z[O] && 0 < R && B.time - w[O] >= y * R && (z[O].gap = !0);
...
(function () {
  ...
  d.TrendLine = d.Class({
    construct: function (a) {
      ...
      var a = this;
      a.destroy();
      var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, w = a.finalXValue, y = a.initialValue, x = a.finalValue, u = p.recalculateToPercents, A = b.dataDateFormat;
...
(function () {
  ...
  d.drop = function (a, b, c, d, h, f, g, k) {
    var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b, p = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, r = .8 * b, w = -b / 3, y = b / 3;
    0 === c && (w = -w, y = 0);
    180 == c && (y = 0);
    90 == c && (w = 0);
    270 == c && (w = 0, y = -y);
  ...
  d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
    ...
    359.94 < x && (x = 359.94);
    h >= x && (h = x);
    var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * w, z = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * g, D = b + Math.sin((e + h) * u) * f, C = c - Math.cos((e + h) * u) * g, K = b + Math.sin((e + h) * u) * k, u = c - Math.cos((e + h) * u) * w, H = {
    ...
    e = a.set();
    var O;
    y && (x = r(10 * x), z = r(10 * z), D = r(10 * D), K = r(10 * K), A = r(10 * A), B = r(10 * B), C = r(10 * C), u = r(10 * u), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, w *= 10, 1 > Math.abs(h) && 1 >= Math.abs(D - z) && 1 >= Math.abs(C - B) && (O = !0));
    h = "";
    var R;
    q && (H["fill-opacity"] = 0, H["stroke-opacity"] = m["stroke-opacity"] / 2, H.stroke = m.stroke);
    if (0 < l) {
      R = " M" + x + "," + (A + l) + " L" + z + "," + (B + l);
      y ? (O || (R += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (B + l) + "," + D + "," + (C + l)), R += " L" + K + "," + (u + l), 0 < k && (O || (R += " B" + (b - k) + "," + (l + c - w) + "," + (b + k) + "," +
        (l + c + w) + "," + K + "," + (l + u) + "," + x + "," + (l + A)))) : (R += " A" + f + "," + g + ",0," + P + ",1," + D + "," + (C + l) + " L" + K + "," + (u + l), 0 < k && (R += " A" + k + "," + w + ",0," + P + ",0," + x + "," + (A + l)));
      R += " Z";
      var ia = l;
      y && (ia /= 10);
    ...
    0 < k && (y ? O || (g += " B" + (b - k) + "," + (c - w) + "," + (b + k) + "," + (c + w) + "," + K + "," + u + "," + x + "," + A) : g += " A" + k + "," + w + ",0," + P + ",0," + x + "," + A);
  ...
  d.AmLegend = d.Class({
    construct: function (a) {
      ...
      var a = this.position, b = this.marginLeft +
        this.titleWidth, c = this.marginRight, e = this.marginTop, h = this.marginBottom, f = this.horizontalGap, g = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, t = 0, r = this.container;
  ...
  d.stringToDate = function (a, b) {
    var c = {}, e = [{pattern: "YYYY", period: "year"}, {pattern: "YY", period: "year"}, {
      ...
      {pattern: "KK", period: "hours"}, {pattern: "K", period: "hours"}, {
        ...
        pattern: "QQQ",
        period: "milliseconds"
      }, {pattern: "QQ", period: "milliseconds"}, {pattern: "Q", period: "milliseconds"}], h = !0, f = b.indexOf("AA");
