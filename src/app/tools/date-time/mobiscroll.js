    ...
    function Scroller(elem, settings) {
        ...
        that.show = function (prevAnim) {
            ...
            html += (s.display != 'inline' ? '' +
              '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '">' +
              '<span class="dwbw dwb-s"><span class="dwb">' + s.setText + '</span></span>' +
              (s.button3 ? '<span class="dwbw dwb-n"><span class="dwb">' +
              s.button3Text + '</span></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb">' +
              s.cancelText + '</span></span></div></div>' : '<div class="dwcc"></div>') +
              '</div></div></div>';
            dw = $(html);
...
<!--  闄堝环宄板鍔犱腑鏂囪祫婧愬寘 (ceo@vmeitime.com)  -->
(function ($) {
    $.mobiscroll.i18n.zh = $.extend($.mobiscroll.i18n.zh, {
        ...
        monthNamesShort: ['1鏈�', '2鏈�', '3鏈�', '4鏈�', '5鏈�', '6鏈�', '7鏈�', '8鏈�', '9鏈�', '10鏈�', '11鏈�', '12鏈�'],
        monthText: '月',
        secText: '秒',
        timeFormat: 'HH:ii',
        timeWheels: 'HHii',
